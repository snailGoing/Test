...
public class ProgressDialogFragment extends DialogFragment {
    ...
    public void onResume() {
        super.onResume();
        if (getDialog() != null) {
            int id = Resources.getSystem().getIdentifier("button3", "id", "android");
            Button mButtonNegative = (Button) getDialog().findViewById(id);
    ...
    public void onStart() {
        ...
        if (mProgressNum == null) {
            ...
            int id = Resources.getSystem().getIdentifier("progress_number", "id", "android");
            TextView view = (TextView) mDialog
                    .findViewById(id);//com.android.internal.R.id.progress_number);
    ...
    public void setProgress(ProgressInfo progeressInfo) {
        ...
        if (progressDialog != null && progeressInfo != null) {
            ...
            TextView messageView = (TextView) progressDialog
                    .findViewById(id);//com.android.internal.R.id.message);
            if (messageView != null) {
