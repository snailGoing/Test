...
import com.sprd.fileexplore.util.UnitUtils;
...
public class CircleProgressBar extends ProgressBar {
    ...
    private final Rect mProgressPerTextRect = new Rect();
    private final Rect mProgressPerTextSigRect = new Rect();
    ...
    private String mProgressTextSig ;
    ...
    private void initFromAttributes(Context context, AttributeSet attrs) {
        ...
        mProgressTextSig = a.getString(R.styleable.CircleProgressBar_progress_text_sig )  ;
    ...
    private void drawProgressText(Canvas canvas) {
        ...
        Log.d("xuehao"," drawProgressText:  progressText="+progressText);
        canvas.drawText(progressText, mCenterX, mCenterY /*+ mProgressTextRect.height() / 2*/, mProgressTextPaint);

        Paint perPaint = new Paint();
        perPaint.setTextSize(mProgressTextSize/2);
        perPaint.setColor(mProgressTextColor);
        String pers = "%";
        perPaint.getTextBounds(pers,0,pers.length(),mProgressPerTextRect);
        canvas.drawText(pers,  mCenterX + mProgressTextRect.width()*3/5, mCenterY - mProgressTextRect.height() / 2, perPaint  );

        Paint textSigPaint = new Paint();
        if(mProgressTextSig==null){
            mProgressTextSig ="";
        }
        textSigPaint.setTextSize(mProgressTextSize*2/5);
        textSigPaint.setColor(mProgressTextColor);
        textSigPaint.getTextBounds(mProgressTextSig, 0, mProgressTextSig.length(),mProgressPerTextSigRect);
        canvas.drawText(mProgressTextSig, mCenterX-mProgressPerTextSigRect.width()/2 ,
                mCenterY + mProgressPerTextSigRect.height()*2,textSigPaint );
    ...
    public void setProgressTextSig(String progressTextSig){
        this.mProgressTextSig = progressTextSig;
        invalidate();
    }
    public String getProgressTextSig(){
        return mProgressTextSig;
    }
