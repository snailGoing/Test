...
public class NetworkRankActivity extends Activity {
    ...
    ArrayList<UidDetail> mAppsDetail;
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case MSG_WIFI_STATS_LOAD_FINISHED:
                    // SPRD: Bug747972 the use of dataflow not sorted in descend order
                    Collections.sort(mApps, new Comparator<UidDetail>() {
                        @Override
                        public int compare(UidDetail a, UidDetail b) {
                            return Double.compare(b.usageSum, a.usageSum);
                        }
                    });
                    /**
                     * SPRD: Bug 702637 Make sure your adapter calls notifyDataSetChanged() when its content changes
                     * @{
                     */
                    mAppsDetail.clear();
                    mAppsDetail.addAll(mApps);
                    /**
                     * @}
                     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppsDetail = new ArrayList<UidDetail>();
        ...
        if (TeleUtils.getPrimarySlot(this) == SIM1_ID) {
        ...
        if (!mDualSimRelease) {
            ...
            mSim1FlowTotalText.setText(String.format(getResources().getString(R.string.data_flow_data),
                    Formatter.formatFileSize(this, mSim1UsageTotal)));
        } else {
            ...
            mSim2FlowTotalText.setText(String.format(getResources().getString(R.string.data_flow_data2),
                    Formatter.formatFileSize(this, mSim2UsageTotal)));
        }
    ...
    private void updateNetworkUsageStatForDualSim(int slotIndex) {
        ...
        long start = getCycleStart(slotIndex == SIM1_ID ? mDataCycleSim1 : mDataCycleSim2);
        int id = (slotIndex == SIM1_ID ? SIM1_ID : SIM2_ID);
        getLoaderManager().restartLoader(id, SummaryForAllUidLoader.buildArgs(template, start,
        ...
        public void onLoadFinished(Loader<NetworkStats> loader, NetworkStats data) {
            ...
            if (loader.getId() == WIFI_ID) {
                ...
                for (int i = 0; i < size; i++) {
                    ...
                    mWifiFlowTotalText.setText(String.format(getResources().getString(R.string.data_flow_wifi),
                            Formatter.formatFileSize(NetworkRankActivity.this, mWifiUsageTotal)));
                }
                ...
                for (int i = 0; i < size; i++) {
                    ...
                    if (mDualSimRelease) {
                        mSim1FlowTotalText.setText(String.format(getResources().getString(R.string.data_flow_data1),
                                Formatter.formatFileSize(NetworkRankActivity.this, mSim1UsageTotal)));
                    } else {
                        mSim1FlowTotalText.setText(String.format(getResources().getString(R.string.data_flow_data),
                                Formatter.formatFileSize(NetworkRankActivity.this, mSim1UsageTotal)));
                    }
                ...
                for (int i = 0; i < size; i++) {
                    ...
                    dt.usageSum = dt.usageSim1 + dt.usageSim2 + dt.usageWifi;
                    mSim2FlowTotalText.setText(String.format(getResources().getString(R.string.data_flow_data2),
                            Formatter.formatFileSize(NetworkRankActivity.this, mSim2UsageTotal)));
                }
...
//                return null;
    ...
    class AppRankAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
             ...
             * @{
             */
            holder.img.setImageDrawable(mAppsDetail.get(position).icon);
            holder.tv.setText(mAppsDetail.get(position).label);
            if(mDualSimRelease) {
                holder.flow_data.setText(String.format(getResources().getString(R.string.data_flow_data1),
                        Formatter.formatFileSize(NetworkRankActivity.this, mAppsDetail.get(position).usageSim1)));
            } else {
            ...
            holder.flow_wifi.setText(String.format(getResources().getString(R.string.data_flow_wifi),
                    Formatter.formatFileSize(NetworkRankActivity.this, mAppsDetail.get(position).usageWifi)));
            holder.flow_sum.setText(String.format(getResources().getString(R.string.data_flow_sum),
                    Formatter.formatFileSize(NetworkRankActivity.this, mAppsDetail.get(position).usageSum)));
            if (mDualSimRelease) {
                holder.flow_data2.setText(String.format(getResources().getString(R.string.data_flow_data2),
                        Formatter.formatFileSize(NetworkRankActivity.this, mAppsDetail.get(position).usageSim2)));
            }
            /**
             * @}
             */
