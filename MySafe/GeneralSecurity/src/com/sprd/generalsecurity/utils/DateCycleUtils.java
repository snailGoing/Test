...
public class DateCycleUtils {
    ...
    public static final String KEY_MONTH_LEFT_RESTRICT = "key_month_flow_left_restrict";
    ...
    public class DataRestriction {
        ...
        public long monthleftRestriction;
    }
    ...
    public DataRestriction getDataFlowRestriction(Context context, int sim) {
        ...
        v = sharedPref.getString(DateCycleUtils.KEY_MONTH_LEFT_RESTRICT, "0");
        dt.monthleftRestriction = (long)(Float.parseFloat(v) * 1024 * 1024);
        return dt;
    }

    private static final int YEAR_2017 = 117;

    public static boolean isSystemTimeCorrect(long monthStart) {
        Date dt = new Date(System.currentTimeMillis());
        return (dt.getYear() >= YEAR_2017);
    }
}
