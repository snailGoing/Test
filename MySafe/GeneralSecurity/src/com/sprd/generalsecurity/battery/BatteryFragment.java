...
public class BatteryFragment extends PreferenceFragment implements
    ...
    /**
     * SPRD: Bug698606 app is uninstalled, but still display in power consumption list.
     * @{
     */
    private boolean isPackageAlreadyInstalled(Context context, String pkgName) {
        ...
        if (averagePower >= MIN_AVERAGE_POWER_THRESHOLD_MILLI_AMP) {
            ...
            for (int i = 0; i < numSippers; i++) {
                ...
                if (entry.sipper.drainType == DrainType.APP) {
                     ...
                     * @{
                     */
                    if (mContext != null && defaultname != null
                            && !isPackageAlreadyInstalled(mContext, defaultname)) {
                        continue;
                    }
                    /**
                     * @}
